...
5. **Empirical validation under anonymization**: the framework is also evaluated on real production telemetry aggregated at team-quarter level with LGPD-safe disclosure control.
...
- **RQ3**: Do anonymized cohorts remain interpretable across quarters when absolute benchmarks are used instead of relative ranks?
